                            ...
                            <div class="accordion-body body-sitio">
                                ...
                                <div class="acordion-btn w-50">    
                                    <div class="function verde">
                                        <a href="../controllers/reporteSemanalAction.php?anio=${reportes.ANIO}&semana=${reportes.NUM_SEMANA}&semana_text=${reportes.SEMANA}&mes=${reportes.MES}" class="fa-solid fa-print blanco" target="_blank"></a>
                                    </div>        
                                </div>
                            </div>
                        </div>
