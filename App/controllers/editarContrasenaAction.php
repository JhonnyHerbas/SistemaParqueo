...
if ($result) {
    ...
    if ($hash == $password) {
        ...
        if ($contrasenia == $verContrasenia) {
           ...
           header("Location: /SistemaParqueo/App/views/editarDocente.php?id_doc=<?php echo $codigo;?>");
           exit();
        }
    } else {
        ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="../views/editarContrasena.php?id_doc=<?php echo $codigo;?>" rel="noopener noreferrer"><button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cerrar</button></a>
                    </div>
                </div>
            </div>
        </div>
