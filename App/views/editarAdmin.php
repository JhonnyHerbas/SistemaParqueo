                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nombre" class="form-control bg-info" id="validationCustom01"
                                    pattern="[a-zA-Z\s]{3,30}" autocomplete="off" spellcheck="false" value="<?php echo $docente['NOMBRE_DOC']; ?>" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="codigo" class="form-control bg-info" id="validationCustom03"
                                    pattern="^[0-9]{9}$" autocomplete="off" spellcheck="false" minlength="5"
                                    maxlength="30" placeholder="Ingrese su código" value="<?php echo $docente['ID_DOC']; ?>" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="correo" class="form-control bg-info" id="validationCustom05"
                                    ...
                                    value="<?php echo $docente['CORREO_DOC']; ?>" readonly>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="apellido" class="form-control bg-info" id="validationCustom02"
                                    ...
                                    maxlength="30" placeholder="Ingrese su apellido" value="<?php echo $docente['APELLIDO_DOC']; ?>" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="celular" class="form-control bg-info" id="validationCustom04"
                                    pattern="^[0-9]{8}$" autocomplete="off" spellcheck="false" minlength="5"
                                    maxlength="30" placeholder="Ingrese su numero" value="<?php echo $docente['CELULAR_DOC']; ?>" readonly>
                                <div class="invalid-feedback">
