        ...
        <div class="card form">
            ...
            <div class="card-body">
                <form id="myForm" class="row g-3 needs-validation" novalidate
                    action="/SistemaParqueo/App/controllers/configuracionHorarioAction.php" method="post">
                    <div class="mb-3">
                        <label for="validationCustom01" class="form-label">Horario de apertura:</label>
                        <input type="text" name="hora-apertura" class="form-control" id="validationCustom01"
                            pattern="^(0?[0-9]|1[0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]$" autocomplete="off"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="hora-cierre" class="form-control" id="validationCustom01"
                            pattern="^(0?[0-9]|1[0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]$" autocomplete="off"
                            spellcheck="false" minlength="8" maxlength="8" placeholder="HH:MM:SS" required>
                        <div class="invalid-feedback">
                            Por favor, ingrese un valor válido para este campo.
