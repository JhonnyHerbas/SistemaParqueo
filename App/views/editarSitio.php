        ...
        <div class="card form">
            ...
            <div class="card-body">
                <form id="myForm" class="row g-3 needs-validation" novalidate
                    action="/SistemaParqueo/App/controllers/editarSitioAction.php" method="post">
                    <div class="mb-3">
                        <label for="validationCustom01" class="form-label">Nombre del sitio:</label>
                        <input type="text" name="name" class="form-control bg-info" id="validationCustom01"
                            pattern="^[a-zA-Z0-9\s]*$" autocomplete="off" spellcheck="false" minlength="5"
                            maxlength="30" value="<?php echo $sitio['NOMBRE_SIT']; ?>"
                            onkeyup="this.value=this.value.replace(/^\s+/,'');" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control bg-info" id="validationCustom02" min="1"
                            autocomplete="off" required name="precio" spellcheck="false" maxlength="10"
                            pattern="^[0-9]*$" value="<?php echo $sitio['PRECIO_SIT']; ?>">
                    ...
                    <div>
                        <input type="hidden" value="<?php echo $sitio['ID_SIT']; ?>" name="id_sit"
                            style="display: none;">
                        <input type="hidden" value="<?php echo $sitio['ID_SEC']; ?>" name="id_sec"
                            style="display: none;">
                    </div>
                    <div class="col-12 button">
                        <button class="btn btn-success" id="submitButton" data-toggle="modal"
                            data-target="#exampleModal">Guardar</button>
                        <a href="visualizarSitio.php" rel="noopener noreferrer"><button type="button"
                                class="btn btn-secondary btn-danger" data-bs-dismiss="modal">Cancelar</button></a>
                    </div>
