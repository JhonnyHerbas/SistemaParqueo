                        ...
                        <div class="izquierda">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nombre" class="form-control bg-info" id="validationCustom01"
                                    ...
                                    value="<?php echo $docente['NOMBRE_DOC']; ?>" readonly>
                        ...
                        <div class="derecha">
                            <div class="mb-3">
                                ...
                                <input type="text" name="apellido" class="form-control bg-info" id="validationCustom02"
                                    ...
                                    maxlength="30" value="<?php echo $docente['APELLIDO_DOC']; ?>" readonly>
                                <div class="invalid-feedback">
                        ...
                        <div class="izquierda">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="codigo" class="form-control bg-info" id="validationCustom03"
                                    ...
                                    maxlength="30" value="<?php echo $docente['ID_DOC']; ?>" readonly>
                                <div class="invalid-feedback">
                        ...
                        <div class="derecha">
                            <div class="mb-3">
                                ...
                                <input type="text" name="celular" class="form-control" id="validationCustom05"
                                    ...
                                    maxlength="30" value="<?php echo $docente['CELULAR_DOC']; ?>" required>
                                <div class="invalid-feedback">
